/**
 * Footer Component - Modern Minimal Design for The Mad Hatters
 * 
 * Features:
  ...
  return (
    <footer className={`bg-white text-gray-700 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Footer Content - Expedia.fr Style */}
              ...
              <ul className="space-y-3">
                {footerLinks.About.map((link) => (
                  <li key={link.name}>
                    <Link
                      to={link.href}
                      className="group flex items-start text-gray-600 hover:text-teal-600 transition-colors duration-200 text-sm leading-relaxed"
                      onMouseEnter={() => setHoveredItem(link.name)}
                      onMouseLeave={() => setHoveredItem(null)}
                    >
                      <span className={`w-1.5 h-1.5 bg-teal-500 rounded-full mr-2.5 mt-1.5 transition-all duration-300 flex-shrink-0 ${
              ...
              <div className="flex space-x-3">
                {socialMedia.map((social) => (
                  <a
                    key={social.name}
                    href={social.href}
                    className="group p-2.5 rounded-lg bg-gray-50 hover:bg-teal-50 border border-gray-200 hover:border-teal-300 transition-all duration-300 hover:scale-110 hover:shadow-md"
                    aria-label={social.name}
                  >
                    <div className="text-gray-500 group-hover:text-teal-600 transition-colors duration-300">
                      {social.icon}
                    </div>
                  </a>
                ))}
            ...
            <div>
              <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    type="submit"
                    className="bg-gradient-to-r from-teal-500 to-blue-500 text-white py-2 px-6 rounded-lg hover:from-teal-600 hover:to-blue-600 transition-all duration-300 font-medium text-sm whitespace-nowrap"
                  >
                    Subscribe
                  </button>
                </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-gray-500">
              <div className="text-center sm:text-left">
                © 2017-2023 The Mad Hatters Pakistan. All Rights Reserved.
              </div>
              <div className="hidden sm:block">•</div>
              <div>Leading women-only experiential tourism company</div>
              <div className="hidden sm:block">•</div>
              <div>Powered By Web Design Pakistan</div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <select 
                ...
                className="bg-white border border-gray-300 rounded-lg px-3 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-teal-500"
              >
