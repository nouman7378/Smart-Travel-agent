        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Rechercher des vols</h1>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
                Pourquoi choisir TravelHub pour vos vols?
              </h2>
                ...
                {[
                  {
                    ...
                    description: 'Comparez les prix de plusieurs compagnies aériennes pour obtenir les meilleures offres',
                  },
                  {
                    icon: '📅',
                    title: 'Dates flexibles',
                    description: 'Consultez les prix sur différentes dates pour trouver les options les moins chères',
                  },
                  {
                    icon: '⭐',
                    title: 'Compagnies de confiance',
                    description: 'Réservez en toute confiance auprès de notre réseau de compagnies aériennes partenaires',
                  },
                ].map((feature, index) => (
                  <motion.div
                    key={index}
