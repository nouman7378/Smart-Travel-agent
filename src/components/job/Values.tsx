 ...
 * Values Component
 * 
 * Culture & Values section (Expedia-style)
 */
...
const Values: React.FC = () => {
  const values = [
    ...
    },
    {
      ...
      title: 'Innovative',
      description: 'We embrace new ideas and push boundaries to solve complex problems',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Trustworthy',
      description: 'We build trust through transparency, honesty, and integrity',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Collaborative',
      description: 'We work together as one team to achieve common goals',
    },
  ];
