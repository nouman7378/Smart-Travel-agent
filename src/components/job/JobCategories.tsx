 ...
 * 
 * Job categories grid (Expedia-style)
 */
...
const JobCategories: React.FC = () => {
  const categories = [
    ...
    },
    {
      ...
      description: 'Drive insights and decisions',
      count: 15,
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-blue-600 font-semibold">{category.count} open positions</span>
