  ...
  return (
    <PageLayout skipHeaderFooter={true} useNewFooter={true}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Submit Payment</h1>
          <p className="text-xl text-gray-600">Complete your payment securely.</p>
        </motion.div>
      </div>
    </PageLayout>
  );
